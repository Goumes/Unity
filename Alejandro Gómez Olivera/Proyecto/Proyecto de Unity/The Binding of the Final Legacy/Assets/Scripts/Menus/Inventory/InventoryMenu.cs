...
public class InventoryMenu : MonoBehaviour
{
    ...
    {
        Invoke("firstSelect", 0.001f);
    }

    /// <summary>
    /// Method that closes the options dialog and selects the first available item slot
    /// </summary>
    ...
    /// <summary>
    /// Method that closes the options dialog and selects the previous selected item slot
    /// </summary>
    ...
    /// <summary>
    /// Method that is called when the gameObject is enabled. It clears the inventory info, reload it and selects the first available item slot.
    /// </summary>
                ...
                case "Item Description":
                    ...
                    for (int j = 0; j < inventoryTexts.transform.GetChild(i).transform.childCount; j++)
                    {
                        switch (inventoryTexts.transform.GetChild(i).transform.GetChild(j).transform.name)
                        {
                            ...
                            case "Health Logo":
                            case "Attack Logo":
                                inventoryTexts.transform.GetChild(i).transform.GetChild(j).gameObject.SetActive(false);
                                break;
                        }
                    }
    ...
    /// <summary>
    /// Method that wipes all the inventory data
    /// </summary>
    ...
    /// <summary>
    /// Method that loads everything it needs for each occuped item slot
    /// </summary>
    ...
    /// <summary>
    /// Method that updates the item info depending on the current selectedItem
    /// </summary>
                ...
                case "Item Description":
                    ...
                    for (int j = 0; j < inventoryTexts.transform.GetChild(i).transform.childCount; j++)
                    {
                        ...
                        switch (inventoryTexts.transform.GetChild(i).transform.GetChild(j).transform.name)
                        {
                            ...
                            case "Health Logo":
                            case "Attack Logo":
                                inventoryTexts.transform.GetChild(i).transform.GetChild(j).gameObject.SetActive(true);
                                break;
                        }
    ...
    /// <summary>
    /// The OnClick method of every button in the inventory but the options dialog
    /// </summary>
    public void OnClick()
    {
        bool selected = false;
    ...
    /// <summary>
    /// Method that places the options dialog on the top right corner of the selected item slot
    /// </summary>
    ...
    /// <summary>
    /// OnClick method of the options dialog
    /// </summary>
